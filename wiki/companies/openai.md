...
- **2026-04-28**: [[microsoft|Microsoft]] and OpenAI Gut Exclusive Cloud Deal, Freeing OpenAI for Multi-Cloud Strategy
- **2026-04-28**: OpenAI [[codex|Codex]] with $20 Plan Called 'Really Good Deal' by Sam Altman
- **2026-04-28**: OpenAI Achieves FedRAMP Moderate Authorization for [[gpt|ChatGPT]] Enterprise and API
- **2026-04-28**: [[microsoft|Microsoft]] and OpenAI Gut Exclusive Deal, OpenAI Gains Freedom to Sell on AWS and [[google-deepmind|Google]] Cloud
- **2026-04-27**: OpenAI Releases Privacy Filter Model for Token Classification
- **2026-04-27**: [[codex|Codex]] Traffic Surge Prompts OpenAI to Scale Compute, CEO Signals Strong Demand
- **2026-04-27**: OpenAI Releases Privacy Filter Model on [[hugging-face|HuggingFace]] for Content Safety
...
- **2026-04-26**: [[gpt|GPT-5.5]] Image 2.0 Demonstrates Breakthrough in Complex Image Generation and Infographics
- **2026-04-25**: GPT-5.5 Launches Across OpenAI API, GitHub [[copilot|Copilot]], and [[perplexity|Perplexity]]
...
- **2026-04-24**: [[anthropic|Anthropic]] Confirms [[claude|Claude]] Performance Degradation Due to Harness Changes
...
- **2026-04-19**: Scale AI CEO Highlights [[muse-spark|Muse Spark]]'s Strong Performance on Agentic Benchmark
...
- **2026-04-03**: [[microsoft|Microsoft]] Launches Three In-House AI Models (Transcribe, Voice, Image) in Foundry
...
- **2026-03-24**: [[openclaw|OpenClaw]] Releases Major Update with Plugin Marketplace and New Models
...
- **2026-03-21**: [[scale-ai|Scale AI]] Launches First Real-World Voice AI Benchmark
- **2026-03-20**: OpenAI Acquires Code Agent Startup Astral to Boost Codex Team
- **2026-03-20**: [[cursor-ai|Cursor]] Releases Composer 2, In-House Coding Model Surpassing Claude Opus 4.6
...
- **2026-03-06**: OpenAI Launches GPT-5.4 with Native [[computer-use|Computer Use]] and 1M Context
...
- **2026-03-03**: [[alibaba|Alibaba]] Releases Ultra-Efficient [[qwen|Qwen3.5]] Small Models (0.8B-9B) for Edge Devices
...
- **2026-02-28**: OpenAI Raises $110B from Amazon, [[nvidia|Nvidia]], SoftBank; ChatGPT Hits 900M Weekly Users
- **2026-02-27**: OpenAI Expands London Research Hub to Compete with [[google-deepmind|DeepMind]]
- **2026-02-25**: OpenAI's GPT-5.3-Codex GA and Claude Code Remote Control Launch

## Key Developments

### Funding & Valuation
OpenAI raised $110B from Amazon, [[nvidia|NVIDIA]], and SoftBank (Feb 28), later completing a $122B round at $852B valuation (Apr 1). ChatGPT reached 900M weekly users. The company also launched a $100M+ Alzheimer's research grant program.

### Product Launches
The [[gpt|GPT]]-5.3-[[codex|Codex]] went GA on Feb 25. GPT-5.4 series followed with mini and nano variants optimized for agent workloads (Mar 18). The frontier GPT-Rosalind for life sciences debuted Apr 17. [[sora|Sora]] 2 Video API launched Mar 13, and ChatGPT Images 2.0 released Apr 22.
...
### Government & Legal
Secured a Pentagon deal after [[anthropic|Anthropic]]'s rejection (Mar 1), faced a $10M lawsuit over AI-generated legal advice hallucination (Mar 9), and the Robotics Head resigned over the Pentagon deal (Mar 8).
...
- **W13 (Water Sellers' Water Getting Cheaper)**: Launched GPT-5.4 mini/nano at dramatically lower prices to delay customer migration to [[open-source-models|open-source alternatives]]. Acquired Astral (uv, Ruff, ty) to extend from "model provider" into "developer platform" — a classic ecosystem lock-in play acknowledging that pure model differentiation is eroding.
- **W14 (Agent Moved into the OS)**: Codex gained plugin support for enterprise workflows (Box integration), positioning it alongside [[claude|Claude]] [[computer-use|Computer Use]] and [[gemini|Gemini]] Screen Automation in the race to become the first agent embedded in users' operating systems.

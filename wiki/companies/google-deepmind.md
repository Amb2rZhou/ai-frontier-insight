...
- **2026-04-28**: 600+ Google Employees Protest Classified Military AI Use to Sundar Pichai
- **2026-04-28**: David Silver Raises $1.1B for Ineffable Intelligence to Build RL Superlearner
- **2026-04-28**: [[microsoft|Microsoft]] and [[openai|OpenAI]] Gut Exclusive Cloud Deal, Freeing OpenAI for Multi-Cloud Strategy
- **2026-04-28**: Google Employees Sign Letter Demanding No Classified Military AI Use
- **2026-04-28**: Google Tests AI Chatbot Search for YouTube ('Ask YouTube')
- **2026-04-28**: DeepMind Co-Founder David Silver Raises $1.1B for RL-Based AI Without Human Data
- **2026-04-28**: [[microsoft|Microsoft]] and [[openai|OpenAI]] Gut Exclusive Deal, OpenAI Gains Freedom to Sell on AWS and Google Cloud
...
- **2026-04-07**: [[anthropic|Anthropic]] Expands Compute Partnership with Google and Broadcom
- **2026-04-07**: Google Releases Offline-First AI Dictation App Using Gemma
- **2026-04-07**: [[ollama|Ollama]] Cloud Launches Subscription for Running Gemma 4
...
- **2026-03-13**: [Update] [[openclaw|OpenClaw]] Releases Hunter & Healer Alpha Models with 1M Context
...
- **2026-02-27**: [[openai|OpenAI]] Expands London Research Hub to Compete with DeepMind
...
- **2026-02-25**: [[grok|Grok]] 4.20 Beta Tops Search Arena, Challenges Frontier Models
...
### Robotics
Folded robotics moonshot Intrinsic into core business (Feb 26). Partnered with Agile Robots (Mar 25). Blueprint for [[enterprise-agents|enterprise AI agent]] development via Google Opal (Feb 28).

## Weekly Insights
- **W12 (Model Race to Habitat War)**: Made Chrome native for agents (no extensions needed) and launched Workspace CLI with 40+ agent skills — competing for the agent execution environment alongside [[microsoft|Microsoft]] and [[nvidia|NVIDIA]], with browser session access creating its own form of platform lock-in.
...
- **W15 (The Math Doesn't Work)**: Released Gemma 4 under Apache 2.0 — the world's #3 model (including closed-source) available for free commercial use. This made "build your own local agent in a weekend" viable, directly enabling users to bypass the "Agent tax" that [[anthropic|Anthropic]] and [[openai|OpenAI]] were imposing. Google's calculus: model free, but Google Cloud earns from running it. Also proposed Agent Skills specification reducing baseline context consumption by 90%.
